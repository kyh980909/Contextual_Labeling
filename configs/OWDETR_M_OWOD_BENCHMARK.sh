...
python -u main_open_world.py \
    ...
    --model_type 'owdetr' --obj_loss_coef 8e-4 --obj_temp 1.3 --freeze_prob_model\
...
python -u main_open_world.py \
    ...
    --model_type 'owdetr' --obj_loss_coef 8e-4 --freeze_prob_model --obj_temp 1.3\
